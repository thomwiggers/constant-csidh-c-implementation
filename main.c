...
int main() {
  ...
  assert(csidh(&pub_alice, &base, &priv_alice, num_batches, max, num_isogenies,
               my));
  ...
  t0 = clock();
  assert(csidh(&shared_alice, &pub_bob, &priv_alice, num_batches, max,
               num_isogenies, my));
  t1 = clock();
  ...
  t0 = clock();
  assert(csidh(&shared_bob, &pub_alice, &priv_bob, num_batches, max,
               num_isogenies, my));
  t1 = clock();
